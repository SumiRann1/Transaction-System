        ...
        if total < 0:
            st.markdown("""
                <div style="
                    ...
                    <h3 style="color:red; margin-bottom:5px;">Total Debt Amount</h3>
                    <h3 style="margin:0;color:red;">₹ {}</h3>
                </div>
            ...
            st.markdown("""
                <div style="
                    ...
                    <h3 style="color:green; margin-bottom:5px;">Total Incoming Amount</h3>
